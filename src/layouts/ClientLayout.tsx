...
export default function ClientLayout() {
  ...
  const navItems = [
    { name: 'Mi Resumen', path: '/client', icon: LayoutDashboard },
    { name: 'Mis Préstamos', path: '/client/my-loans', icon: Banknote },
    { name: 'Reclamaciones', path: '/client/claims', icon: MessageSquare },
  ];
